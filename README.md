...
| 김영기 | 백엔드 프로젝트를 진행하면서 API 개발의 전반적인 개발 과정을 익힐 수 있었습니다. 기존에는 객체관계매핑을 위해 JPA만 사용해보았는데 이번 기회에 조회 기능에서 MyBatis를 사용해보면서 직접 쿼리문을 작성해 데이터를 조회하기 때문에 Entity간의 연관관계 매핑을 비교적 자유롭게 할 수 있다는 것을 알게 되었습니다. 또한, Spring Security를 이용한 인증&인가 방법, Restful한 API 개발을 진행해보면서 잘 모르던 부분에 대해 공부하며 습득할 수 있는 시간이 되었습니다. 중요했던 만큼 프로젝트가 끝나고 나서도 다시 찾아보고 공부해야겠다고 생각했습니다. 게다가, 이번 프로젝트에서 MSA에 대해 배우고 적용해보면서 모놀리식 구조와 MSA 구조의 장단점에 대해 알게 되었습니다. 나아가, 더 다양한 소프트웨어 아키텍처에 대해 찾아봐야겠다고 생각했습니다. 무엇보다 이번 프로젝트에서 팀원들과의 협업을 진행하며 협업의 중요성과 협업 관리에 대해 배울 수 있는 시간이었습니다. 어떻게 task 분배를 하면 좋을지 고민하고 협업 중에 발생한 문제를 해결해 나가고 서로간의 코드리뷰를 진행해주면서 코드를 개발하는 것도 중요한 부분이지만 협업을 통해 완성도를 높이는 것도 중요하다는 것을 깨닫게 되었습니다. |
...
| 임채륜 | 새로운 기술, 새로운 환경, 새로운 사람들과 함께 하는 새로운 프로젝트라서 더욱 떨리는 마음으로 임했고, 열심히 최선을 다 한것 같습니다. MSA에 대해 자세히 알게 되었고 구현하는 방법까지 알게 되어 다시금 다른 프로젝트를 하면, MSA로 할지 모놀리식으로 할지 선택지가 늘어서 값진 경험이 된 것 같습니다. 개발을 하며 어떻게 해야 Rest한지 API에 대해 공부하며 알게되었고, Security의 활용 방법과 JWT의 다양성 및 여러 가지의 중점을 알았습니다. 평소에 해보고 싶었던 결제 모듈 도입이 잘 되어서 좋은 프로젝트 시간이 되었습니다. 지금까지는 배움의 중점을 삼았다면, 앞으로는 완성도의 중점을 두고 나아가겠습니다. |
| 정의진 | 이번 백엔드 프로젝트를 진행하며, Restful API설계에 대한 이해도를 높힐 수 있었고, JPA와 MyBatis의 사용법, Swagger를 이용한 API문서 자동화, JUnit을 사용한 테스트 코드 작성 등 백엔드 개발에 있어 중요한 기술들을 익히고 경험할 수 있어 도움이 많이 된 것 같습니다. 그리고, git hub flow 전략을 사용한 git 협업을 진행하며, 깃을 활용한 프로젝트 진행이 많이 익숙해졌습니다. 아쉬웠던 점은 모놀리식 아키텍처로 진행되던 프로젝트를 msa구조로 변환하여 진행을 하려고 하다 보니, 구조적으로 바뀌는 부분이 많아 많은 어려움을 겪었던게 기억에 남습니다. 좋은 팀원 분들을 만나 많은 의견을 공유하며, 개발에 대한 시야를 넓힐 수 있었고, 부족한 부분은 채워가며, 무사히 프로젝트를 마칠 수 있었던 것 같습니다. |
